package io.java.coding.immutable;
...
public final class EmployeeImmutableDemo {
    ...
    public EmployeeImmutableDemo(String name, Date doj, List<String> mobile, Address address) {
        this.name = name;
        this.doj = doj;
        this.mobile = mobile;
    ...
    public static void main(String[] args) {
        ...
        EmployeeImmutableDemo employee=new EmployeeImmutableDemo("Basant",new Date(),
